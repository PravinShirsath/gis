...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/AssociationController/activelist"><button style="background-color:green;COLOR:white">Active Association list</button></a>
	...
	<table class="table table-hover table-bordered" id="sampleTable" style="display:block;overflow:auto;">
				...
				?>
                  <tr>
                   ...
                   <td><a name='edit' href="<?php echo site_url('AssociationController/edit/'.$id=$associations->id); ?>"><button title="Edit"  name="Edit" id="Edit" class="btn btn-primary"> Edit</button></a></td>                                               
                    <td><button title="Delete" class="btn btn-danger" name="delete" id="delete" value="<?php echo $associations->id; ?>" onclick="discardassociation(this.value);"> Deactivate</button></td>                   
                  </tr>
				 <?php } } ?>
                </tbody>
              </table>
...
$.ajax({
type: 'post',
url: '<?php echo base_url();?>index.php/AssociationController/discard',
data: 'post_id=' + value,
success: function(data)
{
	alert("This Association deactivated Successfully !!!");
location.reload();
}
});
}
