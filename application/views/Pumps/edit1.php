        ...
        <div class="col-md-12">         
                    ...
                    <form class="form-horizontal" action="<?php echo base_url();?>index.php/PumpsController/StoreforAL" method="post" data-parsley-validate="true">
                        ...
                        <div class="form-group row">
						    ...
						    <div class="form-group row">
					 <label class="control-label col-md-2">Select Sales Zone
						<span style="color:red">*</span>
					</label>
					<div class="col-md-4">
						<select class="form-control" placeholder="Pick a Company" name="zonename" required  data-parsley-required-message="Company name cannot be blank">
						
						<option value="">Select</option>                                                                        
							<?php if(isset($zone)){ 
								
								foreach($zone['zone'] as $zonename){
							?>
							<option value="<?php echo $zonename->zonename; ?>"><?php echo $zonename->zonename; ?></option>
                    ...
                    <form action="<?php echo base_url();?>index.php/PumpsController/UpdatePumpProfile" method="post"
                       ...
                       <input type="hidden" value="<?php if(isset($associationId)){ echo $associationId;}?>" name="associationId">
                        ...
                        <div class="tile-footer">
                            <div class="row">
                                <div class="col-md-8 col-md-offset-3">
                                    <button class="btn btn-primary" type="submit" onClick = "this.style.visibility= 'hidden';">
