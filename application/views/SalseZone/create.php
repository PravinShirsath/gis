...
include('includes/header.php');
 //include('includes/sidebar.php');
	if(isset($singlezone))
{
 $singlezone=$singlezone['singlezone']->row();	
...
<main class="app-content">
	...
	<div class="form-group row">
			<h5 style="margin-left:30px;"><a href="<?php echo base_url();?>index.php/SalsezoneController/create"><button style="background-color:powderblue;COLOR:black">Add Sales Zone</button></a>
	...
	<div class="tile">
		<div class="tile-body">
		<form class="form-horizontal" action="<?php echo base_url();?>index.php/SalsezoneController/store" method="post" data-parsley-validate data-toggle="validator">
			<div class="form-group row">
			<label class="control-label col-md-2">Add Sales Zone</label>
			<div class="col-md-4">
			<input class="form-control" name="zonename" type="text" placeholder="Enter Sales Zone" value="<?php if(isset($zonename)){echo $zonename;}?>" required data-parsley-required-message="Company name cannot be blank">
